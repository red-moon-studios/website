  ...
  <p>
    ...
    <input type=hidden name="zip" value="<?php echo $info['zip']?>">
      ...
      <div align="center">
        <table width="799" border="0" cellpadding="3" cellspacing="1">
          <tr>
            <td colspan="3" bgcolor="#990000"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><font size="3" color="#FFFFFF">Job Details: </font></b></font></td>
            </tr>
          <tr>
            ...
            <td colspan="2" bgcolor="#999999" class="small"><select name="ProductGroup" id="ProductGroup">
            </select>            </td>
          </tr>
          <tr>
            ...
            <td colspan="2" bgcolor="#999999" class="small"><select name="ProductType" id="ProductType">
                        </select></td>
          </tr>
          <tr>
            ...
            <td colspan="2" bgcolor="#999999" class="small"><select name="ProductQty" id="ProductQty">
                        </select></td>
          </tr>
          <tr>
            ...
            <td colspan="2" bgcolor="#999999" class="small"><select name="ProductStyle" id="ProductStyle">
                        </select></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td colspan="2" bgcolor="#999999"><textarea name="Comments" cols="50" rows="3" wrap="VIRTUAL" class="small"></textarea>            </td>
          </tr>
          <tr>
            <td colspan="3" bgcolor="#990000"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><font size="3" color="#FFFFFF">Billing Details:</font></b></font></td>
            </tr>
          <tr>
            <td colspan="3" bgcolor="#999999"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">For security reasons Red Moon Studios LLC is now using a separate billing system to handle all payments.<br>
              ...
              <font size="2" face="Verdana, Arial, Helvetica, sans-serif">Our Online Payment system will accept Visa, Mastercard, Discover and eCheck. </font><br>
            </div></td>
            </tr>
          </table>
      </div>
...
Copyright 2003-2010 - All Rights Reserved<br>
 Red Moon Studios, L.L.C. :: A California Corporation </font></TD>
<TD> <IMG SRC="../images/index_38.jpg" ALT="" width="90" height="31"></TD><TD COLSPAN=2 BGCOLOR=#FB0000> 
