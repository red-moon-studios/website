...
addOption("BC", "Select A Product Type", "", ""); //Empty starter option
...
addList("BC-SHORT", "4/1", "4/1-UV1S");
addList("BC-SHORT", "4/4", "4/4-UV2S");
addOption("BC-GANG", "Select A Style", "", 1);
addList("BC-GANG", "4/1", "4/1-UV1S");
addList("BC-GANG", "4/4", "4/4-UV2S");
addList("BC-GANG", "4/4 Spot UV", "4/4-SPOT");
...
addOption("SH", "Select A Product Type", "", ""); //Empty starter option
...
addList("CT-QTY", "500", "500", "CT-STYLE");
...
addOption("CT-STYLE", "Select A Style", "");
addList("CT-STYLE", "4/4", "4/4", 1);
...
addOption("FP-STYLE", "Select A Style", "");
addList("FP-STYLE", "4/4", "4/4", 1);
...
addList("DC", "4\" x 9\" Rack Door Hanger", "4\" x 9\" Rack Door Hanger", "DC-QTY");
