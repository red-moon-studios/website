...
<TABLE WIDTH=800 BORDER=0 CELLPADDING=0 CELLSPACING=0 align="center">
  ...
  <TR> 
    ...
    <blockquote>
      <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><font size="3">Red Moon Studios -  Completed Print Orders</font></b><br>
          </font>
        <?
...
$matches = mysql_query("SELECT * FROM orders WHERE orders.jobstatus LIKE '%Completed%' ORDER BY orders.orderid DESC")or die(mysql_error());
...
$display_block .= " 
        <tr>
          ...
          <td bgcolor=#999999>$ad_update</td>
        </tr>";
}
mysql_close();
?> 
      ...
      <table width="799" border="0" align="center" cellpadding="3" cellspacing="1">
        <tr>
          <td width="70" bgcolor="#003366"><span class="style4">Job Name</span></td>
            ...
            <td bgcolor="#003366"><span class="style4">Completed Date</span></td>
        </tr>
