...
mysql_query("UPDATE orders SET paycardnum=NULL, jobstatus='".$_POST['jobstatus1']."', trackingnum='".$_POST['trackingnum1']."', fedex='".$_POST['fedex1']."', paysubtotal='".$_POST['paysubtotal1']."', payship='".$_POST['payship1']."', paytax='".$_POST['paytax1']."', paytotal='".$_POST['paytotal1']."', updatedate='".$_POST['updatedate1']."', redcomments='".$_POST['redcomments1']."', shipfrom='".$_POST['shipfrom1']."' WHERE orderid='".$_POST['orderid1']."'");
mysql_close();
?>
...
mysql_close();
$to = $info['email'];
$subject = 'Red Moon Studios Order ' . $info['orderid'] . ' Updated -- ' . $info['jobname'] . '';
$message = '
Your order has been recently updated by our staff.
Please review the status below, if you have any questions please feel free to e-mail us at sales@redmoonstudios.net

You can check the status of your job online at any time 24/7 - Simply use this URL, ' . $info['jobstatus'] . '
...
This job will be shipping from our ' . $info['shipfrom'] . ' facility.
...
Shipping From:<br>
<label>
<input name="shipfrom1" type="text" id="shipfrom" value="<?php echo $info['shipfrom']?>">
</label>
<br><br>
