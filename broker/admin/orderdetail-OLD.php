...
mysql_close();
$to = $info['email'];
$subject = 'Order ' . $info['orderid'] . " - Order Updated";
$message = '
Order ' . $info['orderid'] . ' - Order Updated

Your order has been recently updated by our staff. Please review the status below, if you have any questions please feel free to contact us at 888-780-1115 or sales@redmoonstudios.net

Your Order Number is: ' . $info['orderid'] . '
Your Job Name is: ' . $info['jobname'] . '
Your Order Date is: ' . $info['date'] . '

ORDER STATUS: ' . $info['jobstatus'] . '
Tracking Number (if available): ' . $info['trackingnum'] . ' ' . $info['fedex'] . '
...
If you have any questions please feel free to contact us at 888-780-1115 or sales@redmoonstudios.net
...
<TR> <td colspan="22"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">[<a href="index.php">pending orders</a>] [<a href="oldorders.php">completed orders</a>] [<a href="signup.php" target="_blank">add user</a>] [<a href="createorder.php">create job</a>] </font></td>
  <TD> 
