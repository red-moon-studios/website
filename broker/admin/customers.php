...
<TABLE WIDTH=800 BORDER=0 CELLPADDING=0 CELLSPACING=0 align="center">
  ...
  <TR> 
    ...
    <blockquote>
      <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><font size="3">Red Moon Studios - Customer Center </font></b><br>
          </font>
        <?
...
$matches = mysql_query("SELECT * FROM users ORDER BY users.ID ASC")or die(mysql_error());
while ($row = mysql_fetch_array($matches)) { 
$id = $row['ID'] ;
$ad_username = $row['username'] ;
$ad_company = $row['company'] ; 
$ad_contact = $row['contact'] ;
$ad_email = $row['email'] ;
$ad_phone = $row['phone'] ;
$display_block .= " 
        <tr>
          <td bgcolor=#999999><a href=\"custdetail.php?id=$id\">$ad_username</a></td>
          <td bgcolor=#999999>$ad_company</td>
          <td bgcolor=#999999>$ad_contact</td>
          <td bgcolor=#999999>$ad_email</td>
          <td bgcolor=#999999>$ad_phone</td>
        </tr>";
}
mysql_close();
?> 
      ...
      <table width="799" border="0" align="center" cellpadding="3" cellspacing="1">
        <tr>
          <td bgcolor="#003366"><span class="style4">Username</span></td>
            <td bgcolor="#003366"><span class="style4">Company</span></td>
            <td bgcolor="#003366"><span class="style4">Contact</span></td>
            <td bgcolor="#003366"><span class="style4">E-Mail Address</span></td>
            <td bgcolor="#003366"><span class="style4">Phone Number</span></td>
        </tr>
