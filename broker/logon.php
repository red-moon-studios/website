...
// makes sure they filled it in
	...
	if(!$_POST['username'] | !$_POST['pass']) {
        $error = "You did not enter in a username and/or password.";
	}
...
<TABLE WIDTH=800 BORDER=0 CELLPADDING=0 CELLSPACING=0 align="center">
  ...
  <TR> 
    <TD colspan="5"><a href="home.php"></a></TD>
    <TD>&nbsp;</TD>
    <TD COLSPAN=2></TD>
    <TD>&nbsp;</TD>
    <TD></TD>
  ...
  <TR> 
    <TD COLSPAN=22 ROWSPAN=4 valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="535"><form method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
          ...
          <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?php echo $error ?></font> </div></td>
      </tr>
    </table></TD>
