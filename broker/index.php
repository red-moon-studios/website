...
<TABLE WIDTH=800 BORDER=0 CELLPADDING=0 CELLSPACING=0 align="center">
  ...
  <TR> 
    <TD colspan="5"><a href="../index.htm"><IMG SRC="../images/home.jpg" ALT="" WIDTH=73 HEIGHT=23 border="0"></a></TD>
    <TD>&nbsp;</TD>
    <TD COLSPAN=2></TD>
    <TD>&nbsp;</TD>
    <TD></TD>
  ...
  <TR> 
    <TD COLSPAN=22 ROWSPAN=4 valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="535"><form method="post" action="logon.php">
          <table width="60%" border="0" align="center" cellpadding="3" cellspacing="1">
            <tr>
              <td colspan="2" bgcolor="#003366"><div align="center"><strong><font color="#FFFFFF" size="3" face="Verdana, Arial, Helvetica, sans-serif">Broker Area - Login Page</font></strong> </div></td>
              </tr>
            <tr>
              <td width="37%" bgcolor="#999999"><div align="right"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Username:</strong></font></div></td>
              <td width="63%" bgcolor="#003366"><label>
                <input type="text" name="username" maxlength="40">
              </label></td>
            </tr>
            <tr>
              <td width="37%" bgcolor="#999999"><div align="right"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Password:</strong></font></div></td>
              <td width="63%" bgcolor="#003366"><input type="password" name="pass" maxlength="50">            </tr>
            <tr>
          ...
          <div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">If your a designer, print broker or retailer and is interested in becoming<br>
            a broker with Red Moon Studios, please e-mail <a href="mailto:info@redmoonstudios.net">info@redmoonstudios.net</a></font> </div>        
      </tr>
    </table></TD>
