...
<script language="javascript" src="/broker/chainedselects.js">
...
<script language="javascript" src="/broker/orderconfig.js"></script>
</HEAD>
...
<blockquote>
  ...
  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#FF0000">*Denotes a required field.</font></p>
    ...
    <input type=hidden name="username" value="WebOrder">
      <div align="center">
        <table width="799" border="0" cellpadding="3" cellspacing="1">
          ...
          <tr align="left" valign="middle">
            ...
            <td width="73%" bgcolor="#999999"><font size="2"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif"><input type="text" name="company" size="30"></font></font></td>
          </tr>
          <tr align="left" valign="middle">
            ...
            <td width="73%" bgcolor="#999999"><font size="2"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif"><input type="text" name="contact" size="30"></font></font></td>
          </tr>
          <tr align="left" valign="middle">
            ...
            <td width="73%" bgcolor="#999999"><font size="2"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif"><input type="text" name="email" size="30"></font></font></td>
          </tr>
          <tr align="left" valign="middle">
            ...
            <td width="73%" bgcolor="#999999"><font size="2"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif"><input type="text" name="phone" size="30"></font></font></td>
          </tr>
          <tr align="left" valign="middle">
            ...
            <td width="73%" bgcolor="#999999"><font size="2"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif"><input type="text" name="address1" size="30"></font></font></td>
          </tr>
          <tr align="left" valign="middle">
            ...
            <td width="73%" bgcolor="#999999"><font size="2"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif"><input type="text" name="address2" size="30"></font></font></td>
          </tr>
          <tr align="left" valign="middle">
            ...
            <td width="73%" bgcolor="#999999"><font size="2"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif"><input type="text" name="city" size="30"></font></font></td>
          </tr>
          <tr align="left" valign="middle">
            ...
            <td width="73%" bgcolor="#999999"><select name="state" id="state">
          ...
          <tr align="left" valign="middle">
            ...
            <td width="73%" bgcolor="#999999"><font size="2"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif"><input type="text" name="zip" size="30"></font></font></td>
          </tr>
          </table>
      </div>
      <div align="center">
      ...
      <div align="center">
        <table width="799" border="0" cellpadding="3" cellspacing="1">
          ...
          <tr>
            <td colspan="6" align="right" valign="top" bgcolor="#999999" class="style7"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">For security reasons Red Moon Studios LLC is now using a separate billing system to handle all payments.<br>
              After your order goes through verification, 
              you will receive an e-mail with<br>
              proofs of your artwork as well as an electronic invoice.<br>
  <br>
              Please use the link provided in the e-mail to  make your online payment.<br>
              Payment <strong>MUST </strong>be received before your job(s)  will go into production.<br>
              Online Payment is strongly suggested for the  fastest processing.</font><br>
  <font size="2" face="Verdana, Arial, Helvetica, sans-serif">Our Online Payment system will accept Visa, Mastercard, Discover and eCheck.</font></div></td>
            </tr>
          </table>
      </div>
      <div align="center">
            ...
            <td width="27"><table width="775" border="0" align="center" cellpadding="3" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="center" valign="top" bgcolor="#FFFFFF"><font color="#FF0000" size="2" face="Verdana, Arial, Helvetica, sans-serif">By placing an order, you are forming a legally binding contract with<br>
                  ...
                  to be bound by these Terms and Conditions.</font></td>
              </tr>
              </table></td>
            </tr>
          </table>
        <b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Please click only once.</font></b><br>
        <input type="submit" value="Submit Order" style="font-family: verdana; font-size: 10px">
        </div>
    </form></TD>
  <TD> 
